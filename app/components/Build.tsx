...
const Discover = () => {
   return (
      <Section title='Build' image={imageLaptop as StaticImageData} shape={1}>
         <div className='space-y-6 text-base text-neutral-600'>
            <p>
               Based off of the discovery phase, we develop a comprehensive
               roadmap for each product and start working towards delivery. The
               roadmap is an intricately tangled mess of technical nonsense
               designed to drag the project out as long as possible.
            </p>
            <p>
            ...
            <p>
               ...
               after 9pm, several days after the initial email. This reinforces
               the general aura that we are very busy and dissuades clients from
               asking for changes.
            </p>
         </div>
         <Blockquote
